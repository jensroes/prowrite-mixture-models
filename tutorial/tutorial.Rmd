...
For example, a mean of 5 msecs on the log scale are `exp(5.85)` $\approx$ `r round(exp(5.85),0)`. This prior with varying degrees of freedom is visualised in Figure \@ref(fig:logprior).
