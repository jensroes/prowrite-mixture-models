...
(files <- list.files(path, pattern = "_withinword.rda$", full.names = T))
...
(loos <- ls(pattern = "loo_.*_withinword"))
...
file_out <- paste0("stanout/plantra/modelcomparison_withinword.csv")
