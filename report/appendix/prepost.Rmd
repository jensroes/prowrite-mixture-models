...
The pre-post test effect for the PLanTra dataset is reported in Table \ref{tab:retesteffect}. Transition durations were shorter at before-word locations for the post-test. Evidence was negligible for any other comparisons.
...
write_csv(tmp, "../tables/posttest_effect_cellmeans.csv")

apa_table(tmp[,-1],
          align = c("l", "r", "r", "r", "r"), 
          caption = "Mixture model estimates for post-test effect. Cell means are shown for the pre-test and post-test in msecs for fluent interkey intervals, the slowdown for long interkey intervals and the probability of hesitant transitions. The effect for post-test is shown on log scale (for interkey intervals) and logit scale for probability of hesitant interkey intervals. 95% PIs in brackets.",
