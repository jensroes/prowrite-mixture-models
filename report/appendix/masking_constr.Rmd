...
apa_table(tmp[,-1],
          ...
          caption = "Mixture model estimates for masking effect. Cell means are shown for the masked and unmasked writing task for the slowdown (in msecs) and the probability of hesitant transitions. The effect for masking is shown on log scale (for durations) and logit scale for probability of hesitant transitions. 95% PIs in brackets.",
