...
files <- list.files(str_c("../../stanout/", 
                          c("lift", "spl2", "gunnexp2", "plantra", "cato", "c2l1")), 
                    pattern = "mogbetacon.+.csv", full.names = T) # "spl2_shift",
...
apa_table(tmp[,-1],
          ...
          caption = "Transition-location effect. Differences are shown for the hesitation duration (log scale) and the hesitation probability (logit scale); 95\\% PIs in brackets.") 
