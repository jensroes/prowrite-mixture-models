...
apa_table(tmp[,-1],
          ...
          caption = "Effect of transition location on interkey intervals. Differences are shown on log scale (for durations) and logit scale for hesitation probability. 95\\% PIs in brackets.") 
