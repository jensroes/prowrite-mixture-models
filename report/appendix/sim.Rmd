...
\begin{aligned}
(\#eq:simmog)
\text{y} \sim\text{ } & \theta \cdot \text{log}\mathcal{N}(\beta + \delta, \sigma^2_1) +\\
& (1 - \theta) \cdot \text{log}\mathcal{N}(\beta, \sigma^2_2)\\
