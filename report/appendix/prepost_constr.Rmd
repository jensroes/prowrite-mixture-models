...
apa_table(tmp[,-1],
          align = c("l", "r", "r", "r", "r"), 
          caption = "Mixture model estimates for post-test effect. Cell means are shown for the pre-test and post-test in msecs for the slowdown for hesitant interkey intervals (hesitation duration) and the probability of hesitant interkey intervals. The effect for post-test is shown on log scale (for interkey intervals) and logit scale for probability of hesitant interkey intervals. 95% PIs in brackets.",
