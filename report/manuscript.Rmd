---
title             : "Typing in tandem: finite mixture models reveal fundamental parallelism in multi-sentence text composition"
...
# We are grateful for all authors who made their available (to us), in particular Nina Vandermeulen, Alessandra Rossetti, and colleagues. This work was supported by the National Science Foundation under Grant No. 2016868: "ProWrite: Biometric feedback for improving college students' writing processes." and UKRI ESRC under Grant No. ES/W011832/1: "Can you use it in a sentence?: Establishing how word-production difficulties shape text formation."
# 
...
keywords: "Cascade; parallel models; serial models; finite mixture models; Bayesian models; text composition; keystrokes"
...
```{r child = 'appendix/transloc.Rmd', eval=F}
```

\newpage
 
```{r child = 'appendix/shift.Rmd', eval = F}
```
